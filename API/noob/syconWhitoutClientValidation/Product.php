<?php
        ...
        class Product
        {
            ...
            {
                return $this->dp->insert(compact('Client_ID', 'Lot_ID', 'Name', 'Category', 'Measure_ID', 'Quantity'));
            }
            ...
            {
                $r = $this->dp->update($id, compact('Client_ID', 'Lot_ID', 'Name', 'Category', 'Measure_ID', 'Quantity'));
                if ($r === false)
                    throw new RestException(404);
                return $r;
            }
