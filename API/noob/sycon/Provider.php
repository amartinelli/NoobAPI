...
class Provider
{
    ...
    {
        return $this->dp->insert($Client_ID, compact('Client_ID', 'Name', 'Site', 'Phone', 'CPhone', 'Address'));
    }
    ...
    {
        $r = $this->dp->update($Client_ID, $id, compact('Client_ID', 'Name', 'Site', 'Phone', 'CPhone', 'Address'));
        if ($r === false)
            throw new RestException(404);
        return $r;
    }
