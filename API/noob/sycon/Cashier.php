<?php
        ...
        class Cashier
        {
            ...
            {
                return $this->dp->insert(compact('Client_ID', 'Operator_ID', 'Date_Start', 'Date_End', 'Value_Start', 'Value_End', 'Ref'));
            }
            ...
            {
                $r = $this->dp->update($id, compact('Client_ID', 'Operator_ID', 'Date_Start', 'Date_End', 'Value_Start', 'Value_End', 'Ref'));
                if ($r === false)
                    throw new RestException(404);
                return $r;
            }
