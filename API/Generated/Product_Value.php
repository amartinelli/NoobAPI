<?php
        ...
        class Product_Value
        {
            ...
            * @param datetime $Date  {@from body}
            ...
            {
                return $this->dp->insert(compact('Client_ID''Value','Date',));
            }
            ...
            * @param datetime $Date  {@from body}
            ...
            {
                $r = $this->dp->update($id, compact('Client_ID''Value','Date',));
                if ($r === false)
                    throw new RestException(404);
                return $r;
            }
            ...
            * @param datetime $Date  {@from body}
             ...
             * @return mixed
             */
            function patch($id, , $Client_ID = null, $Value = null, $Date = null)
            {
